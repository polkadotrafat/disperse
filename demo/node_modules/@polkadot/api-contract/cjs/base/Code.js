...
class Code extends _Base.Base {
  ...
  #instantiate = (constructorOrId, _ref, params) => {
    ...
    const tx = hasStorageDeposit ? this.api.tx.contracts.instantiateWithCode(value, gasLimit, storageDepositLimit, encCode, encParams, encSalt) // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    ...
    return tx.withResultTransform(result => new CodeSubmittableResult(result, ...((0, _util2.applyOnEvent)(result, ['CodeStored', 'Instantiated'], records => records.reduce((_ref2, _ref3) => {
